        ...
        <div id="wrapper-content" class="wrapper-content pb-13 pt-8">
            <div class="container">
				<div id="submit-listing" class="section-submit-listing pb-2">
                    <form action="{{route('save.subbrand')}}" method="POST" enctype="multipart/form-data">
                    	@csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <select class="form-control" name="category_id" id="show_brand">
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="mb-2 d-flex align-items-center lh-15">
                                            <label class="mb-0 text-dark font-weight-semibold font-size-md lh-15" >Sub-Brand Name</label>
                                        </div>
                                    ...
                                    <table class="table table-striped table-bordered file-export table-hover" id="main_menu-table">
                                        ...
                                        <tbody>
                                            @foreach($subbrands as $subbrand)
                                                <tr>
                                                    <td>{{ $subbrand->parnt->parnt->name }}</td>
                                                    <td>{{ $subbrand->parnt->name }}</td>
                                                    <td>{{ $subbrand->name }}</td>
