        ...
        <div id="wrapper-content" class="wrapper-content pb-13 pt-8">
            <div class="container">
				<div id="submit-listing" class="section-submit-listing pb-2">
                    <form action="{{route('save.mainMenu')}}" method="POST" enctype="multipart/form-data">
                    	@csrf
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Menu name" value="" required="" autofocus="" autocomplete="off">
                                    </div>
                                    <div class="form-group mb-4">
                                        <div class="mb-2 d-flex align-items-center lh-15">
